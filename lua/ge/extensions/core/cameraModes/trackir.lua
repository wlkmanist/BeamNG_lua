...
function C:update(data)
  if data.openxrSessionRunning then return end -- disable potentially conflicting head-tracking systems (like some VR injectors, etc) working on top of the normal VR tracking
