...
return {
  ...
  editor           = { order = 9, icon = "editor",         title = "ui.options.controls.bindings.Editor", simplemenu = false },
  flowgraph        = { order =10, icon = "editor",         title = "Flowgraph Editor", simplemenu = false },
  debug            = { order =11, icon = "bug_report",     title = "ui.options.controls.bindings.GeneralDebug", simplemenu = false },
  vehicle_debug    = { order =12, icon = "settings",       title = "ui.options.controls.bindings.VehicleDebug", simplemenu = false },
}
