...
local function onEditorRegisterPreferences(prefsRegistry)
  ...
  prefsRegistry:registerSubCategory("levelValidator", "general", nil,
  {
    ...
    -- hidden
    {extendedLogs = {"bool", false, "Shows some additional errors in the list"}},
...
local function onEditorAfterSaveLevel(state)
  --startLevelValidation()
end

local function onEditorPreferenceValueChanged(path, value)
  if path == "levelValidator.general.extendedLogs" then
    levelLogs = {}
    checkFinished = nil
  end
end
