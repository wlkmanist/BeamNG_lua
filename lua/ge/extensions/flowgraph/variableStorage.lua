...
-- returns false if already exists, otherwise true
function C:renameVariable(name, newName)
  -- cannot rename if new variable name already exists
  if self.variables[newName] ~= nil then
    return false
  end
