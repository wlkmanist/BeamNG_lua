...
C.pinSchema = {
  { dir = 'in', type = 'number', name = 'startDuration', description = 'Duration of fade transition to black screen.', default = 0.75, hardcoded = true },
  { dir = 'in', type = 'number', name = 'pauseDuration', description = 'Duration of pause at black screen.', default = 0, hardcoded = true },
  { dir = 'in', type = 'number', name = 'endDuration', description = 'Duration of fade transition from black screen.', default = 0.75, hardcoded = true },
