...
local propDespawn, bottom, top, right, left, spawnLine = 40, 11, -42, 10, -10, -48 --11, 3
local score = 0
...
C.pinSchema = {
  ...
  { dir = 'in', type = 'number', name = 'cont11id', description = "A container ID"},
  { dir = 'in', type = 'number', name = 'cont12id', description = "A container ID"},
