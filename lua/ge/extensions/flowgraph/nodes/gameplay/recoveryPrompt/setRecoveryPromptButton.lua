...
C.pinSchema = {
  ...
  { dir = 'in', type = 'number', name = 'order', description = 'Order index in the button list; leave empty for automatic order (last entry).' },
  { dir = 'in', type = 'bool', name = 'fadeActive', hidden = true, default = true, hardcoded = true, description = 'If screen fade transition should happen.' },
