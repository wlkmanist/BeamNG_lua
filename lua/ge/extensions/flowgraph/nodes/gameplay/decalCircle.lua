...
C.description = "Draws a simple decal multiple times radially on the ground. Works like a loading bar."
C.category = 'repeat_instant'

C.pinSchema = {
  { dir = 'in', type = 'vec3', name = 'pos', description = 'Circle center position.' },
