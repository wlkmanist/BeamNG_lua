...
C.pinSchema = {
  ...
  { dir = 'in', type = 'number', name = 'suspectFrequency', hidden = true, default = 0.5, description = 'Suspect frequency for wanted AI drivers (from 0 to 1)' },
...
function C:workOnce()
  ...
  if self.pinIn.suspectFrequency.value ~= nil then
    self.vars.suspectFrequency = self.pinIn.suspectFrequency.value
  end
