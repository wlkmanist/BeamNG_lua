...
return function(M)
  ...
  function M.Knob(string_label, floatPtr_value, float_v_min, float_v_max, float_speed, string_format, ImGuiKnobVariant_variant, float_size, ImGuiKnobFlags_flags, int_steps)
    ...
    return C.imgui_Knob(string_label, floatPtr_value, float_v_min, float_v_max, float_speed, string_format, ImGuiKnobVariant_variant, float_size, ImGuiKnobFlags_flags, int_steps)
  end
  ...
  M.KnobFlags_DragHorizontal = C.ImGuiKnobFlags_DragHorizontal

  M.KnobVariant_Tick = C.ImGuiKnobVariant_Tick
  M.KnobVariant_Dot = C.ImGuiKnobVariant_Dot
  M.KnobVariant_Wiper = C.ImGuiKnobVariant_Wiper
  M.KnobVariant_WiperOnly = C.ImGuiKnobVariant_WiperOnly
