...
function M.GetContentRegionAvailWidth() return C.imgui_GetContentRegionAvailWidth() end
...
function M.PushTabStop(bool_tab_stop) C.imgui_PushTabStop(bool_tab_stop) end
function M.PopTabStop() C.imgui_PopTabStop() end
function M.PushAllowKeyboardFocus(bool_allow_keyboard_focus) C.imgui_PushTabStop(bool_allow_keyboard_focus) end
function M.PopAllowKeyboardFocus() C.imgui_PopTabStop() end
...
M.FocusedFlags_DockHierarchy = C.ImGuiFocusedFlags_DockHierarchy
...
M.HoveredFlags_DockHierarchy = C.ImGuiHoveredFlags_DockHierarchy
...
M.Mod_Shortcut = C.ImGuiMod_Shortcut
...
M.Key_KeysData_SIZE = C.ImGuiKey_KeysData_SIZE
M.Key_KeysData_OFFSET = C.ImGuiKey_KeysData_OFFSET
M.Key_ModCtrl = C.ImGuiKey_ModCtrl
M.Key_ModShift = C.ImGuiKey_ModShift
M.Key_ModAlt = C.ImGuiKey_ModAlt
M.Key_ModSuper = C.ImGuiKey_ModSuper
M.Key_KeyPadEnter = C.ImGuiKey_KeyPadEnter
--===
--=== enum ImGuiNavInput ===
...
M.StyleVar_DockingSeparatorSize = C.ImGuiStyleVar_DockingSeparatorSize
...
function M.ImGuiIO_AddMouseViewportEvent(ImGuiIO_ctx, ImGuiID_id) C.imgui_ImGuiIO_AddMouseViewportEvent(ImGuiIO_ctx, ImGuiID_id) end
...
function M.ImGuiListClipper_IncludeRangeByIndices(ImGuiListClipper_ctx, int_item_begin, int_item_end) C.imgui_ImGuiListClipper_IncludeRangeByIndices(ImGuiListClipper_ctx, int_item_begin, int_item_end) end
function M.ImGuiListClipper_ForceDisplayRangeByIndices(ImGuiListClipper_ctx, int_item_begin, int_item_end) C.imgui_ImGuiListClipper_ForceDisplayRangeByIndices(ImGuiListClipper_ctx, int_item_begin, int_item_end) end
--===
--=== struct ImColor ===
...
function M.ImDrawCmd_GetTexID(ImDrawCmd_ctx) return C.imgui_ImDrawCmd_GetTexID(ImDrawCmd_ctx) end
--===
--=== struct ImDrawVert ===
--===
...
function M.ImDrawList_PrimWriteIdx(ImDrawList_ctx, int_idx) C.imgui_ImDrawList_PrimWriteIdx(ImDrawList_ctx, int_idx) end
...
function M.ImFontAtlas_GetGlyphRangesGreek(ImFontAtlas_ctx) return C.imgui_ImFontAtlas_GetGlyphRangesGreek(ImFontAtlas_ctx) end
...
M.ViewportFlags_IsMinimized = C.ImGuiViewportFlags_IsMinimized
M.ViewportFlags_IsFocused = C.ImGuiViewportFlags_IsFocused
--===
...
--===
function M.GetKeyIndex(ImGuiKey_key) return C.imgui_GetKeyIndex(ImGuiKey_key) end
function M.SetItemAllowOverlap() C.imgui_SetItemAllowOverlap() end
...
--===
--=== enum ImGuiModFlags_ ===
M.ModFlags_None = C.ImGuiModFlags_None
M.ModFlags_Ctrl = C.ImGuiModFlags_Ctrl
M.ModFlags_Shift = C.ImGuiModFlags_Shift
M.ModFlags_Alt = C.ImGuiModFlags_Alt
M.ModFlags_Super = C.ImGuiModFlags_Super
--===
