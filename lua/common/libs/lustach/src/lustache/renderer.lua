local Scanner  = require "common/libs/lustach/src/lustache/scanner"
local Context  = require "common/libs/lustach/src/lustache/context"

local error, ipairs, loadstring, pairs, setmetatable, tostring, type =
      error, ipairs, loadstring, pairs, setmetatable, tostring, type
local math_floor, math_max, string_find, string_gsub, string_split_lustache, string_sub, table_concat, table_insert, table_remove =
      math.floor, math.max, string.find, string.gsub, string.split_lustache, string.sub, table.concat, table.insert, table.remove
...
function renderer:parse(template, tags)
  ...
  while not scanner:eos() do
    ...
    if type == "=" then
      tags = string_split_lustache(value, patterns.space)
