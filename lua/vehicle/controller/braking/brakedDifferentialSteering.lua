...
--Purpose: Used to implement tank-like steering with a differential braking system
...
local function updateGFX(dt)
  ...
  --reduce brake effect at low speeds, keep at high speeds
  local brakedSteeringSpeedCoef = linearScale(electrics.values.wheelspeed or 0, 0, 0.2, 0, 1)
...
local function init(jbeamData)
  ...
  if not leftSteeringWheel or not rightSteeringWheel then
    log("E", "brakedDifferentialSteering.init", "Left or right steering wheel not found")
    M.updateGFX = nop
