...
--Purpose: controller for emulating dynamic brake lights and related things like hazards control
...
local function updateGFX(dt)
  ...
  if isEnabled then
    ...
    if emergencyBrakingHazardsArmed and not emergencyBrakingHazardsActive and absActive > 0 and wheelspeed < hazardActivateSpeed and activateHazardsAfterEmergencyBraking then
